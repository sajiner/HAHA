...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self ) {
        ...
        self.blueIndexDic =[[NSMutableDictionary alloc] initWithDictionary: @{@"项目状态":@(0),@"借款期限":@(0),@"项目收益":@(0),@"借款类型":@(0)}];
        self.valueTypeDic =[[NSMutableDictionary alloc] initWithDictionary: @{@"项目状态":@[@0,@6,@5,@7,@8,@9],@"借款期限":@[@0,@1,@2,@3,@4],@"项目收益":@[@0,@1,@2,@3,@4],@"借款类型":@[@0,@1,@2,@6,@4,@3,@5]}];
    }
    return self;
}
...
- (void)popShowButton:(UIButton *)sender{
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(popClickTitle:value:)]) {
        ...
        [[NSNotificationCenter defaultCenter]postNotificationName:@"hideSanBiaoHeaderViewBtn" object:nil userInfo:@{@"btnTitle":btnTitle}];
