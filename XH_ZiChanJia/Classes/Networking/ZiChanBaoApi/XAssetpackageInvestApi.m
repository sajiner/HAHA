...
@interface XAssetpackageInvestApi()
@property (nonatomic,copy)NSMutableString *params;

@end

@implementation XAssetpackageInvestApi{
    NSString * _token;
    CGFloat _amount;
    CGFloat _income;
    NSInteger _pid;
...
- (NSMutableString *)params{
    if (!_params) {
        _params = [NSMutableString stringWithString:Request_AssetpackageInvestProject];
